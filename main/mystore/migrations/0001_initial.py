    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timings', to='mystore.storetimezone')),
            ],
        ),
        migrations.CreateModel(
            name='StoreStatusLog',
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_logs', to='mystore.storetimezone')),
            ],
        ),
        migrations.CreateModel(
            name='StoreReport',
            fields=[
                ...
                ('store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='mystore.storetimezone')),
            ],
        ),
    ]
